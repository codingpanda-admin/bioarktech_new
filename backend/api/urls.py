...
from .admin_views import (
    ...
    admin_create_catalog_group, admin_update_catalog_group, admin_delete_catalog_group,
...
urlpatterns = [
    ...
    path('admin-panel/catalog-groups/<int:group_id>/delete/', admin_delete_catalog_group),
